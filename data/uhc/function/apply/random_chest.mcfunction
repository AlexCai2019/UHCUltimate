...
execute at @s if score #map_size border matches 496 run spreadplayers ~ ~ 64 232 false @e[tag=chest]
execute at @s if score #map_size border matches 752 run spreadplayers ~ ~ 64 360 false @e[tag=chest]
execute at @s if score #map_size border matches 1008 run spreadplayers ~ ~ 64 488 false @e[tag=chest]
execute at @s if score #map_size border matches 1264 run spreadplayers ~ ~ 64 616 false @e[tag=chest]
execute at @s if score #map_size border matches 1520 run spreadplayers ~ ~ 64 744 false @e[tag=chest]
