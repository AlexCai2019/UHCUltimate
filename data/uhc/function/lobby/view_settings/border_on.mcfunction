...
execute if score 00000000-0000-0000-0000-000000000006 border_mode matches 1 run tellraw @s \
[\
	"",\
...
execute if score 00000000-0000-0000-0000-000000000007 border_mode matches 1 run tellraw @s \
[\
	"",\
...
execute if score 00000000-0000-0000-0000-000000000008 border_mode matches 1 run tellraw @s \
[\
	"",\
