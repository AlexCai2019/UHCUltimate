...
#no-warden
execute if score 00000000-0000-0000-0000-000000000001 warden_spawn matches 1 run tellraw @s {text: "", "extra": [{text: "伏守生成", color: "gold"}, {text: " | ", color: "white"}, {text: "開啟", color: "green"}]}
execute if score 00000000-0000-0000-0000-000000000001 warden_spawn matches 0 run tellraw @s {text: "", "extra": [{text: "伏守生成", color: "gold"}, {text: " | ", color: "white"}, {text: "關閉", color: "red"}]}
#initial supplies
