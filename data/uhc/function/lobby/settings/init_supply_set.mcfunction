...
#save settings
execute if entity @a[scores={book=1033}] if entity @s[scores={init_supply=1}] at @s if items block ~3 ~ ~7 container.* * run data modify storage uhc:data root.init_items set from block ~3 ~ ~7 Items
execute if entity @a[scores={book=1033}] if entity @s[scores={init_supply=1}] at @s unless items block ~3 ~ ~7 container.* * run data remove storage uhc:data root.init_items
