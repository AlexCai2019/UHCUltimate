...
#ramdom assignment
execute if score @s random_team_num matches 2.. run team join red @r[team=solo]
execute if score @s random_team_num matches 2.. run team join blue @r[team=solo]
execute if score @s random_team_num matches 3.. run team join green @r[team=solo]
execute if score @s random_team_num matches 4.. run team join yellow @r[team=solo]
execute if score @s random_team_num matches 5.. run team join purple @r[team=solo]
execute if score @s random_team_num matches 6.. run team join gray @r[team=solo]
execute if score @s random_team_num matches 7.. run team join red_dark @r[team=solo]
execute if score @s random_team_num matches 8.. run team join blue_dark @r[team=solo]
execute if score @s random_team_num matches 9.. run team join green_dark @r[team=solo]
execute if score @s random_team_num matches 10.. run team join gold @r[team=solo]
execute if score @s random_team_num matches 11.. run team join aqua @r[team=solo]
execute if score @s random_team_num matches 12.. run team join aqua_dark @r[team=solo]
execute if score @s random_team_num matches 13.. run team join pink @r[team=solo]
execute if score @s random_team_num matches 14.. run team join gray_dark @r[team=solo]
