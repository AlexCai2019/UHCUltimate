...
#win judge
execute if score @s[scores={betray=1}] timer_min < #betray_tp betray unless entity @a[gamemode=survival, tag=!betrayer] unless entity @a[tag=win] run function uhc:win
