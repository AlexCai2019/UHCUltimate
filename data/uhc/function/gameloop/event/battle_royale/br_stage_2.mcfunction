#########################################################
# UHC Project 
# Name    : br_stage_2.mcfunction 
# Made by : jelly99709 
# Path    : /gameloop/event/battle_royale/
# Loop    : No. Execute as tag=move
# func    : BR_stage 2, calculate x, z diff & start moving.
#########################################################

#notifier
execute at @a run playsound minecraft:entity.firework_rocket.launch master @a ~ ~ ~
tellraw @a {text: "", "extra": [{text: "UHCE >>> ", color: "gray"}, {score: {name: "00000000-0000-0000-0000-000000000001", objective: "timer_min"}, color: "red"}, {text: "分鐘", color: "red"}, {text: " | ", color: "white"}, {text: "隨機縮圈模式", color: "gold"}, {text: " | ", color: "white"}, {text: "第一階段啟動", color: "red"}]}
