...
execute if score #map_size border matches 496 run scoreboard players set 安全區半軸長 information 56
execute if score #map_size border matches 752 run scoreboard players set 安全區半軸長 information 88
execute if score #map_size border matches 1008 run scoreboard players set 安全區半軸長 information 120