#########################################################
# UHC Project 
# Name    : br_stage_7.mcfunction 
# Made by : jelly99709 
# Path    : /gameloop/event/battle_royale/
# Loop    : No. Execute as tag=move
# func    : BR_stage 7, choose a coordinate randomly within 96*96 .
#########################################################
...
#scoreboard players set 00000000-0000-0000-0000-000000000001 BR_size 8
scoreboard players set 安全區半軸長 information 8