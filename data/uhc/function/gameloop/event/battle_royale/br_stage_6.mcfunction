...
execute as 00000000-0000-0000-0000-000000000001 if score #map_size border matches 496 run function uhc:gameloop/event/battle_royale/border/496_3
execute as 00000000-0000-0000-0000-000000000001 if score #map_size border matches 752 run function uhc:gameloop/event/battle_royale/border/752_3
execute as 00000000-0000-0000-0000-000000000001 if score #map_size border matches 1008 run function uhc:gameloop/event/battle_royale/border/1008_3
