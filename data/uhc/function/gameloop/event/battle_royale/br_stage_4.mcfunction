#########################################################
# UHC Project 
# Name    : br_stage_4.mcfunction 
# Made by : jelly99709 
# Path    : /gameloop/event/battle_royale/
# Loop    : No. Execute as tag=move
# func    : BR_stage 4, calculate x, z diff & start moving .
#########################################################
...
execute as 00000000-0000-0000-0000-000000000001 if score #map_size border matches 496 run function uhc:gameloop/event/battle_royale/border/496_2
execute as 00000000-0000-0000-0000-000000000001 if score #map_size border matches 752 run function uhc:gameloop/event/battle_royale/border/752_2
execute as 00000000-0000-0000-0000-000000000001 if score #map_size border matches 1008 run function uhc:gameloop/event/battle_royale/border/1008_2
