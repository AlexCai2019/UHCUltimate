...
execute as 00000000-0000-0000-0000-000000000001 if score @s map_size matches 496 run function uhc:gameloop/event/battle_royale/border/496_2
execute as 00000000-0000-0000-0000-000000000001 if score @s map_size matches 752 run function uhc:gameloop/event/battle_royale/border/752_2
execute as 00000000-0000-0000-0000-000000000001 if score @s map_size matches 1008 run function uhc:gameloop/event/battle_royale/border/1008_2
