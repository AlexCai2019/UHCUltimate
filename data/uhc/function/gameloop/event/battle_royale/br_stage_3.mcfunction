...
execute if score 00000000-0000-0000-0000-000000000001 map_size matches 496 run scoreboard players set 安全區半軸長 information 120
execute if score 00000000-0000-0000-0000-000000000001 map_size matches 752 run scoreboard players set 安全區半軸長 information 184
execute if score 00000000-0000-0000-0000-000000000001 map_size matches 1008 run scoreboard players set 安全區半軸長 information 248