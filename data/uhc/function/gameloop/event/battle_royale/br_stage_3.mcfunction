#########################################################
# UHC Project 
# Name    : br_stage_3.mcfunction 
# Made by : jelly99709 
# Path    : /gameloop/event/battle_royale/
# Loop    : No. Execute as tag=move
# func    : BR_stage 3, choose a coordinate randomly within 128*128 .
#########################################################
...
execute if score #map_size border matches 496 at @s run spreadplayers ~ ~ 1 64 false 00000000-0000-0000-0000-000000000009
execute if score #map_size border matches 752 at @s run spreadplayers ~ ~ 1 96 false 00000000-0000-0000-0000-000000000009
execute if score #map_size border matches 1008 at @s run spreadplayers ~ ~ 1 128 false 00000000-0000-0000-0000-000000000009
...
#scoreboard players set 00000000-0000-0000-0000-000000000001 BR_size 120
execute if score #map_size border matches 496 run scoreboard players set 安全區半軸長 information 120
execute if score #map_size border matches 752 run scoreboard players set 安全區半軸長 information 184
execute if score #map_size border matches 1008 run scoreboard players set 安全區半軸長 information 248