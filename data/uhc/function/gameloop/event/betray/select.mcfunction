...
execute if score #betray_num betray > 剩餘隊伍 information run function uhc:gameloop/event/betray/pre_select1
execute if score #betray_num betray <= 剩餘隊伍 information run function uhc:gameloop/event/betray/pre_select2

execute if score #betray_num betray matches 1 run tag @r[tag=candidate, limit=1] add betrayer
execute if score #betray_num betray matches 2 run tag @r[tag=candidate, limit=2] add betrayer
execute if score #betray_num betray matches 3 run tag @r[tag=candidate, limit=3] add betrayer
execute if score #betray_num betray matches 4 run tag @r[tag=candidate, limit=4] add betrayer
...
scoreboard players set #betray_time betray 999