...
execute if entity @s[scores={timer_sec=30}] as @a at @s run playsound minecraft:block.anvil.land master @s ~ ~ ~
execute if entity @s[scores={timer_sec=11..20}] as @a at @s run playsound minecraft:block.note_block.hat master @s ~ ~ ~
execute if entity @s[scores={timer_sec=1..10}] as @a at @s run playsound minecraft:block.note_block.pling master @s ~ ~ ~
