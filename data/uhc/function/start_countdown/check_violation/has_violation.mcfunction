...
execute as 0-0-0-0-1 if score @s betray matches 1 if score @s betray_tp <= @s betray_time run return run function uhc:start_countdown/check_violation/betray_time_violation

scoreboard players operation #temp betray_tp = 00000000-0000-0000-0000-000000000001 betray_tp
...
scoreboard players operation #temp_border_start border += 00000000-0000-0000-0000-000000000001 BR_shrink_time
execute if score 00000000-0000-0000-0000-000000000008 border_mode matches 1 as 0-0-0-0-1 if entity @s[scores={border_on=1, betray=1}] if score #temp_border_start border <= #temp betray_tp run return run function uhc:start_countdown/check_violation/betray_br_violation_1
execute if score 00000000-0000-0000-0000-000000000008 border_mode matches 0 as 0-0-0-0-1 if entity @s[scores={border_on=1, betray=1}] if score temp_border_start border < @s betray_time run return run function uhc:start_countdown/check_violation/betray_br_violation_0
