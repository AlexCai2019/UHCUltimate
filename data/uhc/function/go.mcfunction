...
#book settings --- no warden
execute if score @s warden_spawn matches 0 run gamerule doWardenSpawning false
...
execute if score @s day_time matches 0 if score @s day_stop matches 1 if score 00000000-0000-0000-0000-000000000008 day_mode matches 1 run time set midnight
execute if score 00000000-0000-0000-0000-000000000008 day_mode matches 1 run scoreboard players operation @s day_time -= const7 VII
