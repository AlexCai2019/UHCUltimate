...
execute as 00000000-0000-0000-0000-000000000001 if entity @s[scores={underclock=0, state=2}] run return run function uhc:gameloop/game4
execute as 00000000-0000-0000-0000-000000000001 if entity @s[scores={underclock=1, state=2}] run return run function uhc:gameloop/game1
execute as 00000000-0000-0000-0000-000000000001 if entity @s[scores={underclock=2, state=2}] run return run function uhc:gameloop/game2
execute as 00000000-0000-0000-0000-000000000001 if entity @s[scores={underclock=3, state=2}] run return run function uhc:gameloop/game3
