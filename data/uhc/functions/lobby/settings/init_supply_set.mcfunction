...
execute if entity @a[scores={book=1032}] if entity @s[scores={init_supply=1}] run setblock ~4 ~1 ~7 minecraft:birch_wall_sign[facing=north]{Color:"green",Text4:'{"text":""}',Text3:'{"text":""}',Text2:'{"text":"儲存設定","bold":true}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger book set 1033"},"text":""}'}
execute if entity @a[scores={book=1032}] if entity @s[scores={init_supply=1}] run setblock ~2 ~1 ~7 minecraft:birch_wall_sign[facing=north]{Color:"red",Text4:'{"text":""}',Text3:'{"text":""}',Text2:'{"text":"取消變更","bold":true}',Text1:'{"clickEvent":{"action":"run_command","value":"trigger book set 1034"},"text":""}'}
